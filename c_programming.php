...
$sql="select * from paper where parent='c_programming'";
...
<table id="main_table">
  <tr>
    ...
    <tr>
      ...
      <td><a href="view.php?id=<?=$row['id'];?>"><button>View</button></a></td>
      <!-- <td><a href="view.php?id=<?=$row;?>"><button>Download</button></a> --></td>
