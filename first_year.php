...
<table class="main_table">
  ...
  <tr>
     <td>
       <a href="./paper_viewer/c_programming.php">
         ...
         <div class="block" style="background-color:#E53935;
            ...
            <div class="c_programming">C Programming</div>
    ...
    <td>
      <a href="./paper_viewer/c++.php"><div class="block" style="background-color:#424242;
                                   background-size: cover;">

        <div class="subject">
           <!-- <img src="java.png" height="80"> -->
        </div>
        <div class="c_plus_plus">C++</div>
    
      </div>
    </a>
</td>
  <td><a href="./paper_viewer/maths_165.php"><div class="block" style="background-color:#00695C;
                                   background-size: cover;">
...
<!-- 2nd tr -->
  ...
  <tr>
  <td><a href="./paper_viewer/engineering_drawing.php"><div class="block" style="background-color:#2E7D32;
                                   background-size: cover;">
    ...
    <div class="eng_drawing">Engineering Drawing</div>
    
  </div></a></td>
  <td><a href="./paper_viewer/ece.php"><div class="block" style="background-color:#F9A825;
                                   background-size: cover;">
  ...
  <td><a href="./paper_viewer/digital_electronics.php"><div class="block" style="background-color:#1DE9B6;
                                   background-size: cover;">
    ...
    <div class="digital_electronics">Digital<br>Electronics</div>
   ...
   <tr>
      <td>
       <a href="./paper_viewer/physics.php">
     ...
     <td>
       <a href="./paper_viewer/pel_121.php">
     ...
     <td>
       <a href="./paper_viewer/pel_131.php">

         <div class="block" style="background-color:#C2185B;
                                   background-size: cover;">
   ...
   <tr>
      <td>
       <a href="./paper_viewer/che.php">

         <div class="block" style="background-color:#0D47A1;
                                   background-size: cover;">
     ...
     <td>
       <a href="./paper_viewer/internet_programming.php">
         ...
         <div class="block" style="background-color:#1B5E20;
            ...
            <div class="internet_programming">Internet<br>Programming</div>
     ...
     <td>
       <a href="./paper_viewer/maths_166.php">
   ...
   <tr>
      <td>
       <a href="./paper_viewer/mechanics.php">
         ...
         <div class="block" style="background-color:#B71C1C;
            ...
            <div class="mechanics">Mechanics</div>
