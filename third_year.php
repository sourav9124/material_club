...
<table class="main_table">
  ...
  <tr>
     <td>
       <a href="./paper_viewer_third_year/computer_graphics.php">
         ...
         <div class="block" style="background-color:#E53935;
            ...
            <div class="computer_graphics">Computer Graphics</div>
    ...
    <td>
      <a href="./paper_viewer_third_year/aptitude.php"><div class="block" style="background-color:#424242;
                                   background-size: cover;">

        <div class="subject">
           <!-- <img src="java.png" height="80"> -->
        </div>
        <div class="aptitude">Aptitude</div>
    
      </div>
    </a>
</td>
  <td><a href="./paper_viewer_third_year/php.php"><div class="block" style="background-color:#00695C;
                                   background-size: cover;">
...
<!-- 2nd tr -->
  ...
  <tr>
  <td><a href="./paper_viewer_third_year/mvc_programming.php"><div class="block" style="background-color:#2E7D32;
                                   background-size: cover;">
    ...
    <div class="mvc_programming">MVC<br>Programming</div>
    
  </div></a></td>
  <td><a href="./paper_viewer_third_year/machine_learning.php"><div class="block" style="background-color:#F9A825;
                                   background-size: cover;">
    ...
    <div class="machine_learning">Machine Learning</div>
    
  </div>
</a>
</td>
  <td><a href="./paper_viewer_third_year/cyber_security.php"><div class="block" style="background-color:#BF360C;
                                   background-size: cover;">
    ...
    <div class="cyber_security">Cyber<br>Security</div>
